...
function onInit()
	...
	DB.addHandler(DB.getPath(node, "*.durability"), "onUpdate", onArmorChanged);
	DB.addHandler(DB.getPath(node, "*.maxdurability"), "onUpdate", onArmorChanged);
    DB.addHandler(DB.getPath(node, "*.frame"), "onUpdate", onArmorChanged);
	...
	DB.addHandler(DB.getPath(node, "*.properties"), "onUpdate", onArmorChanged);
...
function onClose()
	...
	DB.removeHandler(DB.getPath(node, "*.durability"), "onUpdate", onArmorChanged);
	DB.removeHandler(DB.getPath(node, "*.maxdurability"), "onUpdate", onArmorChanged);
    DB.removeHandler(DB.getPath(node, "*.frame"), "onUpdate", onArmorChanged);
	...
	DB.removeHandler(DB.getPath(node, "*.properties"), "onUpdate", onArmorChanged);
