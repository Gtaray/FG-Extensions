...
function update()
	...
	if updateControl("maxdurability", bReadOnly, bID) then bSection3 = true; end
	-- ReadOnly flag is a combination of readonly + value == "" so that
	-- the control is only ever hidden when it is empty and readonly, otherwise
	-- it is never readonly
	if updateControl("durability", (bReadOnly and self["maxdurability"].getValue() == ""), bID) then bSection3 = true; end
	...
	if updateControl("frame", bReadOnly, bID and bArmor) then bSection4 = true; end
